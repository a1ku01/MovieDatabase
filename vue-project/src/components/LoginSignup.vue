      ...
      <div class="overlay-container">
        <div class="overlay">
          ...
          <div class="overlay-panel overlay-right">
            <h1>Hello, Friend!</h1>
            <p>Enter your personal details and start reviewing films with us</p>
            <div class="social-container">
              <a href="#" class="social"><i class="fab fa-facebook-f"></i></a>
              <a href="#" class="social"><i class="fab fa-google-plus-g"></i></a>
              <a href="#" class="social"><i class="fab fa-linkedin-in"></i></a>
            ...
            <span>or use your email for registration</span>
            <input v-model="userNickname" type="text" placeholder="Name" id="userNickname" required/>
            <input v-model="userEmail" type="email" placeholder="Email" id="userEmail" required/>
            <input v-model="userPassword" type="password" placeholder="Password" id="userPassword" required/>
            <button class="ghost" @click="signup()" id="signUp">Sign Up</button>
          </div>
        </div>
      </div>
    </div>
